  ...
  return (
    <div className="flex flex-row flex-wrap justify-between h-full w-full pb-2 overflow-clip">
      <div className="flex flex-col basis-[49%] h-[49%] relative">
        <ChartPref className="absolute top-2.5 left-20" pprofType={PprofType.cpu} />
        <PprofGraph pprofType={PprofType.cpu} />
      </div>
      <div className="flex flex-col basis-[49%] h-[49%] relative ">
        <ChartPref className="absolute top-2.5 left-20" pprofType={PprofType.heap} />
        <PprofGraph pprofType={PprofType.heap} />
      </div>
      <div className="flex flex-col basis-[49%] h-[49%] relative">
        <ChartPref className="absolute top-2.5 left-20" pprofType={PprofType.allocs} />
        <PprofGraph pprofType={PprofType.allocs} />
      </div>
      <div className="flex flex-col basis-[49%] h-[49%] relative ">
        <ChartPref className="absolute top-2.5 left-32" pprofType={PprofType.goroutine} />
